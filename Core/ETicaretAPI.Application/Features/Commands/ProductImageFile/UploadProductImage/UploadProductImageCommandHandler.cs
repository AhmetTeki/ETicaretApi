...
{
    public class UploadProductImageCommandHandler : IRequestHandler<UploadProductImageCommadnRequest, UploadProductImageCommandResponse>
    {
        ...
        public async Task<UploadProductImageCommandResponse> Handle(UploadProductImageCommadnRequest request, CancellationToken cancellationToken)
        {
