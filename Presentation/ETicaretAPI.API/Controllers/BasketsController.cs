...
using ETicaretAPI.Application.Features.Commands.Basket.UpdateQuentity;
...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class BasketsController : ControllerBase
    {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateQuentity(UpdateQuentityCommandRequest updateQuentityCommandRequest)
        {
            UpdateQuentityCommandResponse response =await _mediator.Send(updateQuentityCommandRequest);
            return Ok(response);
        }
